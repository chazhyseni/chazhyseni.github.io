...
* [<i class="fas fa-user"></i> About](about.md)
* [<i class="fas fa-microscope"></i> Research](research.md)
* [<i class="fas fa-book"></i> Publications](publications.md)
* [<i class="fas fa-project-diagram"></i> Projects](projects.md)
...
* [<i class="fas fa-file-pdf"></i> CV](files/cv.pdf ":target=_blank")

---

* **Links**
  * [<i class="fab fa-github"></i> GitHub](https://github.com/chazhyseni ":target=_blank")
